...
const config = require('./data/5/config')
const weaponTable = require('./data/5/weapons/weapontable')
const weaponText = require('./data/5/weapons/weapontext.en')
...
;(function(){
  ...
  if(!keepSaves) replaceAll('\\My Games\\EDF5\\SAVE_DATA\\', saveDir)
